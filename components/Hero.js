      ...
      <div className="grid items-center gap-12 md:grid-cols-[1.2fr_1fr]">
        <div className="animate-fade-up">
          ...
          <p className="mt-6 max-w-md text-lg leading-relaxed text-neutral-600">
            데이터와 콘텐츠로 브랜드의 성장을 설계하는 퍼포먼스 마케터입니다.
            현재{" "}
            <span className="font-semibold text-neutral-900 underline decoration-accent decoration-4 underline-offset-2">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <a
              href="#projects"
              className="rounded-full border border-neutral-900 px-6 py-3 text-sm font-semibold text-neutral-900 transition-colors hover:bg-neutral-900 hover:text-white"
            >
              View My Work
            </a>
          </div>
        ...
        {/* 프로필 이미지 — public/images/profile.svg 를 실제 사진으로 교체하세요 */}
        <div className="animate-fade-up justify-self-center md:justify-self-end">
          <div className="relative">
            ...
            <div className="relative aspect-square w-56 overflow-hidden rounded-lg bg-neutral-100 sm:w-72">
              <Image
